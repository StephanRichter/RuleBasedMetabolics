...
<h2><?php echo __('Parameters Use'); ?></h2>
	<dl>
		<dt><?php echo __('Puid'); ?></dt>
		<dd>
			<?php echo h($parametersUse['ParametersUse']['puid']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Parameters Use'), array('action' => 'edit', $parametersUse['ParametersUse']['puid'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Parameters Use'), array('action' => 'delete', $parametersUse['ParametersUse']['puid']), null, __('Are you sure you want to delete # %s?', $parametersUse['ParametersUse']['puid'])); ?> </li>
